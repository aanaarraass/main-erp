odoo.define('web.FieldAchievement', function (require) {
"use strict";
    ...
    */
    ...
    _renderBody: function () {
        ...
        var grouped_by = _.groupBy(this.state.data, function (record) {
            return record.data[self.groupBy];
        });
...
var FieldAchievement = FieldOne2Many.extend({
...
field_registry.add('ach_page', FieldAchievement);

return FieldAchievement;
