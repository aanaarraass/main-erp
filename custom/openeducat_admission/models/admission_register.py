...
class OpAdmissionRegister(models.Model):
    ...
    year_equivalent = fields.Selection(
        [('14', '14 Year Equivalent'), ('16', '16 Year Equivalent'), ('18', '18 Year Equivalent'),
         ('21', '21 Year Equivalent'),
         ('other', 'Other'),
         ],
        'Equivalent Year', default='16', require=True, tracking=True)
    year_of_degree = fields.Selection(
        [('2_year', '2 Year Program'), ('3_year', '3 Year Program'), ('4_year', '4 Year Program'),
         ('other', 'Other'),
         ],
        'Year of Degree Program', default='4_year', require=True, tracking=True)
