...
class TestReport(common.TransactionCase):
    def setUp(self):
        ...
        self.xlsx_report = self.env[
            "report.openeducat_attendance_report_xlsx.abstract"].with_context(
            active_model="res.partner"
        )
        self.report_name = "openeducat_attendance_report_xlsx.partner_xlsx"
