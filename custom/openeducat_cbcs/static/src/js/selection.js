odoo.define('openeducat_cbcs.batch_on_courses', function (require) {
    "use strict";
    ...
    publicWidget.registry.SubjectRegister.include({
        events: {
            'click .subject_registration_submit': '_onFormSubmit',
...
//    websiteRootData.websiteRootRegistry.add(SubjectSelection, '.js_get_data');
    //publicWidget.registry.SubRegister = SubRegister;
    //return SubRegister;
