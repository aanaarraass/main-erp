...
class DashboardProMainDashboard(models.Model):
    ...
    def get_item_data(self, dashboard_rec):
        ...
        for x_rec in dashboard_rec.to_do_list_line:
    ...
    def create(self, vals):
        ...
        if "dashboard_top_menu_id" in vals and "menu_name_dashboard" in vals:
            action_id = {
                "name": vals["menu_name_dashboard"] + " Action",
            ...
            record.dashboard_menu_id = (
                ...
                .create(
                    {
                        "name": vals["menu_name_dashboard"],
                        "active": vals.get("dashboard_active", True),
                        "parent_id": vals["dashboard_top_menu_id"],
                        "action": "ir.actions.client," + str(record.client_action.id),
