...
class GradebookGradebook(models.Model):
    ...
    def create(self, vals):
        ...
        return super(GradebookGradebook, self).create(vals)
    ...
    def calculate_percentage(self):
        ...
        for key, value in term_lst.items():
            for key1, value1 in value.items():
                ...
                if value1:
                    try:
                        for key2, value2 in subterm_dict_2.items():
                ...
                if type(value) != bool:
                    for key1, value1 in value.items():
                        if type(value1) is dict:
                            ...
                            if subject_data_1:
                                data.append({
                                    'semester_total': value1['override'] if value1['override'] in value1 else value1['Total'], # noqa
                                    key1: subject_data_1,
                                    'semester_gpa': value1['GPA'] if 'GPA' in value1 else None, # noqa
