...

{
    ...
    'description': """This module allows you to manage the notices/circulars easily.
    Admin/Faculty can create notice/circular, publish it & students and parents can
    view that on their portal.""",
    'version': '15.0.1.0',
    'category': 'Education',
    "sequence": 3,
