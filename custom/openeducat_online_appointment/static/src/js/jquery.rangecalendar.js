...
//				cell = '<button type="button"><i class="fas fa-angle-left"></i></button>'
//                cell = '<div class="cal-cell cell" date-id="'+dayNumber+'" week-id="'+day+'" month-id="'+monthNumber+'" month="'+monthNumber+'">';
				cell = '<div class="cal-cell cell" get-year-id="'+fullYear+'" get-date-id="'+dayNumber+'" date-id="'+fullYear+monthNumber+dayNumber+'" week-id="'+day+'" get-month-id="'+monthNumber+'" month-id="'+fullYear+''+monthNumber+'" month="'+monthNumber+'">';
				...
				cell += '</div>';
				cell += '</div>';
//				cell += '<button class="slick-next" aria-label="Next" type="button"><i class="fas fa-angle-right"></i></button>';
