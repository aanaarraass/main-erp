odoo.define('web.FieldStudentSkills', function (require) {
"use strict";
...
var AbstractGroupedOne2ManyRenderer = ListRenderer.extend({
    ...
    groupTitleTemplate: 'student_default_group_row', // Template used to render the title row of a group
...
var SkillsRenderer = AbstractGroupedOne2ManyRenderer.extend({
    ...
    groupBy: 'student_skill_type_id',
    dataRowTemplate: 'student_skill_data_row',
...
field_registry.add('student_skills', FieldSkills);
