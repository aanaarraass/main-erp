    ...
    def create_invoice(self):
        ...
        return {
            ...
            "context": {"default_total_amount": self.amount_total,
                        ...
                        "default_property_selling_price": self.property_contract_id.property_selling_price,
                        "default_discount_amount": self.property_contract_id.discount_amount,
                        "default_total_emi_amount": self.property_contract_id.total_emi_amount,
                        "default_paid_installment_emi": self.property_contract_id.paid_installment_emi,
                        "default_remaining_balance": self.property_contract_id.remaining_balance,
                        "default_contract_total_amount_with_tax": self.property_contract_id.contract_total_amount_with_tax,
...
class AccountMove(models.Model):
    ...
    property_contract_id = fields.Many2one("property.property.contract",)
