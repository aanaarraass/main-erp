...
class Property(models.Model):
    ...
    def get_default_uom_categ(self):
        ...
        print('def get_default_uom_categ(self):')
        # if uom_categ_id:
    ...
    def get_default_uom(self):
        uom_categ_id = self.env["uom.category"].search([("for_property_area", "=", True)], limit=1)
        print('def get_default_uom(self):')
        # if uom_categ_id:
    ...
    expected_price = fields.Monetary(store=True, readonly=False)
    selling_price = fields.Monetary(related='expected_price', store=True, readonly=False)
