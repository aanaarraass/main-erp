...
class StudentStudent(models.Model):
    ...
    cnic_bform = fields.Char(
        string="B-form/CNIC",
        help="CNIC or B-Form whichever you have",
    )
    ...
    parent_info_line = fields.One2many(comodel_name='school.parent', inverse_name='children_id', string='Parent Info.')
