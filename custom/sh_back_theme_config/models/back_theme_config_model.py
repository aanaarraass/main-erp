...
class sh_back_theme_config_settings(models.Model):
    ...
    sidebar_color_2 = fields.Char(string="Background Color 2")
    ...
    def action_preview_theme_style(self):
        if self:
            ...
            if context and context.get('which_style', '') == 'login_page':
                img_src = "/sh_back_theme_config/static/src/img/preview/login_page/style_login.png"

            if context and context.get('which_style', '') == 'mobile':
                img_src = "/sh_back_theme_config/static/src/img/preview/mobile_preview.png"

            if context and context.get('which_style', '') == 'checkbox':
                img_src = "/sh_back_theme_config/static/src/img/preview/checkbox_style_preview.png"

            if context and context.get('which_style', '') == 'radio':
                img_src = "/sh_back_theme_config/static/src/img/preview/radio_btn_style_preview.png"

            if context and context.get('which_style', '') == 'scrollbar_style':
                img_src = "/sh_back_theme_config/static/src/img/preview/scrollbar_style_gif.gif"

            if context and context.get('which_style', '') == 'discuss_chatter_style':
                img_src = "/sh_back_theme_config/static/src/img/preview/discuss_chatter/discuss_chatter.png"

            if context and context.get('which_style', '') == 'enterprise_svg':
                img_src = "/sh_back_theme_config/static/src/img/preview/enterprise_svg_preview.png"

            if context and context.get('which_style', '') == 'loading':
                img_src = "/sh_back_theme_config/static/src/img/preview/loading-gif.gif"
            
            if context and context.get('which_style', '') == 'app_icon_style':
                img_src = "/sh_back_theme_config/static/src/img/preview/app_icon_style.png"

            if context and context.get('which_style', '') == 'breadcrumb_style':
                img_src = "/sh_back_theme_config/static/src/img/preview/breadcrumb_style.png"

            if context and context.get('which_style', '') == 'horizontal_tab_style':
                img_src = "/sh_back_theme_config/static/src/img/preview/horizontal_tab_style.png"
        
            if context and context.get('which_style', '') == 'vertical_tab_style':
                img_src = "/sh_back_theme_config/static/src/img/preview/vertical_tab_style.png"
            
            if context and context.get('which_style', '') == 'form_element_style':
                img_src = "/sh_back_theme_config/static/src/img/preview/form_element_style.png"
