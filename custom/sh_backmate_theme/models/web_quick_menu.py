...
class res_users(models.Model):
    ...
    def SELF_READABLE_FIELDS(self):
        return super().SELF_READABLE_FIELDS + ['sh_enable_multi_tab','sh_enable_quick_menu_mode','sh_enable_full_width_form', 'sh_enable_night_mode','sh_enable_language_selection','sh_enable_full_screen_mode','sh_enable_calculator_mode','sh_enable_gloabl_search_mode','sh_enable_todo_mode','sh_enable_zoom']

    @property
    def SELF_WRITEABLE_FIELDS(self):
            return super().SELF_WRITEABLE_FIELDS + ['sh_enable_multi_tab','sh_enable_quick_menu_mode','sh_enable_full_width_form', 'sh_enable_night_mode','sh_enable_language_selection','sh_enable_full_screen_mode','sh_enable_calculator_mode','sh_enable_gloabl_search_mode','sh_enable_todo_mode','sh_enable_zoom']
