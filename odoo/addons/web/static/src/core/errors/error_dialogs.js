...
ErrorDialog.title = _lt("BMS Error");

// -----------------------------------------------------------------------------
// Client Error Dialog
// -----------------------------------------------------------------------------
export class ClientErrorDialog extends ErrorDialog {}
ClientErrorDialog.title = _lt("BMS Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _lt("BMS Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = this.env._t("BMS Server Error");
                break;
            case "script":
                this.title = this.env._t("BMS Client Error");
                break;
            case "network":
                this.title = this.env._t("BMS Network Error");
                break;
        }
    }
...
export class RedirectWarningDialog extends Dialog {
    setup() {
        ...
        this.title = capitalize(subType) || this.env._t("System Warning");
        this.message = message;
